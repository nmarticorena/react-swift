!(function () {
  ...
  var t = 'undefined' != typeof module && void 0 !== module.exports,
    ...
    M = t ? require('./download') : window.download,
  ...
  parseFloat, parseInt
  var a = o[typeof exports] && exports && !exports.nodeType ? exports : void 0,
    s = o[typeof module] && module && !module.nodeType ? module : void 0,
    c = s && s.exports === a ? a : void 0,
    h = r(a && s && 'object' == typeof global && global),
  ...
  function _(t) {
    'image/webp' !== document.createElement('canvas').toDataURL('image/webp').substr(5, 10) &&
      ...
      (this.frames = 0),
      (this.part = 1),
      (this.videoWriter = new n({ quality: this.quality, fileWriter: null, fd: null, frameRate: this.framerate }))
  }
  function H(t) {
    f.call(this, t),
  ...
  function G(t) {
    f.call(this, t),
      ...
      (this.sizeSet = !1),
      (this.encoder = new i({ workers: t.workers, quality: t.quality, workerScript: t.workersPath + 'gif.worker.js' })),
      this.encoder.on(
        'progress',
        function (t) {
          this.settings.onProgress && this.settings.onProgress(t)
  ...
  function y(t) {
    var e,
      ...
      l = !1,
      f = {}
    ;(c.framerate = c.framerate || 60),
      (c.motionBlurFrames = 2 * (c.motionBlurFrames || 1)),
      (e = c.verbose || !1),
      c.display,
      (c.step = 1e3 / c.framerate),
      (c.timeLimit = c.timeLimit || 0),
      (c.frameLimit = c.frameLimit || 0),
      (c.startTime = c.startTime || 0)
    ...
    ;(w.style.position = 'absolute'),
      ...
      (w.style.color = 'red'),
      (w.style.zIndex = 1e5),
      c.display && document.body.appendChild(w)
    var y,
      g,
      v = document.createElement('canvas'),
      b = v.getContext('2d')
    P('Step is set to ' + c.step + 'ms')
    var T = { gif: G, webm: _, ffmpegserver: H, png: z, jpg: U, 'webm-mediarecorder': V },
      F = T[c.format]
    ...
    function E() {
      ;(l = !1),
        ...
        (window.Date.prototype.getTime = O),
        (window.Date.now = j),
    ...
    function R() {
      ...
      ;(n = o + e),
        ...
        (function () {
          ...
          var e = new Date(null)
          e.setSeconds(t),
            2 < c.motionBlurFrames
              ? (w.textContent =
                  'CCapture ' + c.format + ' | ' + m + ' frames (' + d + ' inter) | ' + e.toISOString().substr(11, 8))
              : (w.textContent = 'CCapture ' + c.format + ' | ' + m + ' frames | ' + e.toISOString().substr(11, 8))
        })(),
        P('Frame: ' + m + ' ' + d)
      ...
      start: function () {
        !(function () {
          function t() {
            return (
              this._hooked ||
                ((this._hooked = !0), (this._hookedTime = this.currentTime || 0), this.pause(), B.push(this)),
              this._hookedTime + c.startTime
            )
          }
          P('Capturer start'),
            (o = window.Date.now()),
          ...
          try {
            Object.defineProperty(HTMLVideoElement.prototype, 'currentTime', { get: t }),
              Object.defineProperty(HTMLAudioElement.prototype, 'currentTime', { get: t })
          } catch (t) {
            P(t)
          }
        })(),
          ...
          (2 < c.motionBlurFrames
            ? ((e = t),
              (v.width === e.width && v.height === e.height) ||
                ((v.width = e.width),
                (v.height = e.height),
                (y = new Uint16Array(v.height * v.width * 4)),
                (b.fillStyle = '#0'),
                b.fillRect(0, 0, v.width, v.height)),
              (function (t) {
                b.drawImage(t, 0, 0), (g = b.getImageData(0, 0, v.width, v.height))
                for (var e = 0; e < y.length; e += 4)
                  (y[e] += g.data[e]), (y[e + 1] += g.data[e + 1]), (y[e + 2] += g.data[e + 2])
                d++
              })(t),
              d >= 0.5 * c.motionBlurFrames
                ? (function () {
                    for (var t = g.data, e = 0; e < y.length; e += 4)
                      (t[e] = (2 * y[e]) / c.motionBlurFrames),
                        (t[e + 1] = (2 * y[e + 1]) / c.motionBlurFrames),
                        (t[e + 2] = (2 * y[e + 2]) / c.motionBlurFrames)
                    for (
                      b.putImageData(g, 0, 0), s.add(v), d = 0, P('Full MB Frame! ' + ++m + ' ' + n), e = 0;
                      e < y.length;
                      e += 4
                    )
                      (y[e] = 0), (y[e + 1] = 0), (y[e + 2] = 0)
                    gc()
                  })()
                : i())
            : (s.add(t), P('Full Frame! ' + ++m)))
      },
      stop: E,
      save: A,
      on: function (t, e) {
  ...
  ;(f.prototype.start = function () {}),
    ...
    (w.prototype.add = function (t) {
      ...
      ;(e.onload = function () {
        this.tape.append(l(this.count) + this.fileExtension, new Uint8Array(e.result)),
          0 < this.settings.autoSaveTime && this.frames / this.settings.framerate >= this.settings.autoSaveTime
            ? this.save(
                function (t) {
                  ;(this.filename = this.baseFilename + '-part-' + l(this.part)),
                    M(t, this.filename + this.extension, this.mimeType)
                  var e = this.count
                  this.dispose(),
                    (this.count = e + 1),
                    this.part++,
    ...
    'function' == typeof define && 'object' == typeof define.amd && define.amd
      ...
      : a && s
      ? (c && ((s.exports = y).CCapture = y), (a.CCapture = y))
      : (u.CCapture = y)
})()
